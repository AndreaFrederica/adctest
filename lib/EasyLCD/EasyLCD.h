...
#define LCD_CS PBout(P_CS)
#define LCD_RS PBout(P_RS)
#define LCD_RST PBout(P_RST)
// 如果使用官方库函数定义下列底层，速度将会下降到14帧每秒，建议采用我司推荐方法
// 以下IO定义直接操作寄存器，快速IO操作，刷屏速率可以达到28帧每秒！

#define LCD_CS_SET \
	LCD_CS = 1 // GPIO_TYPE->BSRRL=1<<LCD_CS    //片选端口  	PB11
#define LCD_RS_SET LCD_RS = 1 // GPIO_TYPE->BSRRL=1<<LCD_RS    //数据/命令  PB10
#define LCD_RST_SET \
	LCD_RST = 1 // GPIO_TYPE->BSRRL=1<<LCD_RST    //复位			PB12

#define LCD_CS_CLR \
	LCD_CS = 0 // GPIO_TYPE->BSRRH=1<<LCD_CS     //片选端口  	PB11
#define LCD_RS_CLR LCD_RS = 0 // GPIO_TYPE->BSRRH=1<<LCD_RS     //数据/命令 PB10
#define LCD_RST_CLR \
	LCD_RST = 0 // GPIO_TYPE->BSRRH=1<<LCD_RST    //复位			  PB12
